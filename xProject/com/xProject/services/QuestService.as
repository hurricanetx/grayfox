package com.xProject.services
{
    ...
    public class QuestService extends EventDispatcher
    {
		...
		private static const FALL_THROUGH:String = "";
		
		private static const CREATE_TABLE_QUEST:String = "CreateQuest";
		private static const CREATE_TABLE_STAFF:String = "CreateStaff";
		private static const CREATE_TABLE_MEMBER:String = "CreateMember";
		
		public static const CREATION_COMPLETE:String = "creationComplete";
		public static const CREATION_ERROR:String = "creationError";
		
		private static const DB:String = "xProject.db";
		...
		private function invalidate():void
		{
			...
			var sqlCreateQuest:String = "CREATE TABLE IF NOT EXISTS quest (" +
			...
			var sqlCreateStaff:String = "CREATE TABLE IF NOT EXISTS staff (" +
				"id    INTEGER PRIMARY KEY," +
				"name    TEXT    NOT NULL," +
				"description    TEXT    NOT NULL);";
			
			var sqlCreateMember:String = "CREATE TABLE IF NOT EXISTS member (" +
				"quest_id    INTEGER NOT NULL," +
				"staff_id    INTEGER NOT NULL," +
				"assign_percent    INTEGER    NOT NULL," +
				"percent    INTEGER    NOT NULL," +
				"constraint idx_pk primary key (quest_id,staff_id));";
